...
cmd:option('--dataset', 'Custom', 'which dataset to use : Svhn | Mnist | NotMnist | Cifar10 | Cifar100 | Custom')
cmd:option('--dataPath', '/home/boer/leuko/jpg', 'Where to look for the images')
...
elseif opt.dataset == 'Custom' then
   ds = buildDataSet(opt.dataPath, 0.15, 3, 64, 64)
else
